        ...
        const fetchFood = async () => {
            try {
                const response = await axios.get(
                    `${import.meta.env.VITE_API}/api/item/${id}`,
                    { withCredentials: true }
                );
                const food = response.data.item || response.data;
                setName(food.name || '');
            ...
            <div className="create-food-page">
                <div className="create-food-card">
                    <header className="create-food-header">
                        <h1 className="create-food-title">Edit Food</h1>
                        <p className="create-food-subtitle">Update your food item details.</p>
                    </header>
